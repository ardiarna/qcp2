...
var frm = "include/fg_ad_report.inc.php";

function lihatData(rg_id) {
    $('#myModal').modal('show');
    $.post(frm+"?mode=lihatdata", {rg_id:rg_id} , function(resp,stat){
...
$(document).ready(function () {
    ...
    $('#btnExport').click(function(){
        ...
        if (frmt == 'PDF') {
            ...
            window.open("include/mpdf-6.1.4/fg_ad_report.pdf.php?subplan="+$("#cmbSubplan").val()+"&shift="+$("#cmbshift").val()+"&tanggal="+$("#tglFrom").val()+"@"+$("#tglTo").val(),"",opsi);    
        } else if (frmt == 'XLSX') {
            opsi = "width=900,height=600,screenX=500,toolbars=1,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable='no'";
