      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="frm1">
                ...
                <input class="form-control input-sm" type="hidden" name="fapr_id" id="fapr_id" readonly>
                <input class="form-control input-sm" type="hidden" name="jnsaksi" id="jnsaksi" readonly>
                
                <div class="form-group">
                    <label for="fapr_desc">Parameter :</label>
                    <input type="text" class="form-control" id="fapr_desc" name="fapr_desc">
                </div>
            </form>  
        </div>
...
var frm = "include/fg_fault_parameter.inc.php";
var vdropmenu = false;
var validator = "";
...
function tambahData($plan){
    ...
    document.getElementById("fapr_id").value = '';
    document.getElementById("fapr_desc").value = '';
    document.getElementById("jnsaksi").value = 'add';
    $("#frmmdl").modal();
}

function editData2($plan,$fapr_id,$fapr_desc){
    document.getElementById("subplanid").value = $plan;
    document.getElementById("fapr_id").value = $fapr_id;
    document.getElementById("fapr_desc").value = $fapr_desc;
