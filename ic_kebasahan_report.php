...
session_start(); 
$akses = $_SESSION[$app_id]['app_priv']['133'];
?>
<style type="text/css">
    .adaborder {
        font-size:11px;
            ...
            <div class="box-body" id="boxAwal">
                <form class="form-horizontal" id="frCari">
                    <div class="form-group">
                        <label class="col-sm-1 control-label" style="text-align:left;margin-top:3px;">Dari :</label>
...
var frm = "include/ic_kebasahan_report.inc.php";
...
$(document).ready(function () {
    ...
    $('#btnExport').click(function(){
        ...
        if (frmt == 'PDF') {
            ...
            window.open("include/mpdf-6.1.4/ic_kebasahan_report.pdf.php?tanggal="+$("#tglFrom").val()+"@"+$("#tglTo").val(),"",opsi);    
        } else {
            opsi = "width=900,height=600,screenX=500,toolbars=1,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable='no'";
