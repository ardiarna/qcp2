...
session_start(); 
$akses = $_SESSION[$app_id]['app_priv']['137'];
?>
<style type="text/css">
    .adaborder {
        font-size:11px;
...
var frm = "include/ic_tes_material_kimia_report.inc.php";
...
$(document).ready(function () {
    ...
    $('#btnExport').click(function(){
        ...
        if (frmt == 'PDF') {
            ...
            window.open("include/mpdf-6.1.4/ic_tes_material_kimia_report.pdf.php?subplan="+$("#cmbSubplan").val()+"&tanggal="+$("#tglFrom").val()+"@"+$("#tglTo").val(),"",opsi);    
        } else {
            opsi = "width=900,height=600,screenX=500,toolbars=1,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable='no'";
