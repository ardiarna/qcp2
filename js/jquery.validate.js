...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Harap isi kolom ini dengan benar.",
		...
		dateISO: "Harap masukkan format tanggal yang valid.",
		number: "Harap masukkan format angka yang valid.",
		digits: "Kolom ini harap diisi dengan angka.",
		equalTo: "Kolom ini harus sama dengan kolom diatas.",
		...
		rangelength: $.validator.format( "Harap masukkan nilai dengan panjang karakter antara {0} dan {1}." ),
		...
		step: $.validator.format( "Harap masukkan kelipatan dari {0}." )
	},
