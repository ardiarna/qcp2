      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="frm1">
                ...
                <input class="form-control input-sm" type="hidden" name="groupd1id" id="groupd1id" readonly>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="cd_type" id="cd_type">
...
var frm = "include/prdryingparameter.inc.php";
var vdropmenu = false;
var validator = "";
...
function tampilTabel(tblnya, pgrnya, pTanggal, pSubPlan = 'All'){
    ...
    jQuery(tblnya).jqGrid({
        ...
        datatype:"json",
        colModel:[
            {label:"SUBPLANT", name:'sub_plan', index:'sub_plan', width:70, align:'center'},
...
function editData2($plan,$grup,$id1,$d2,$valdata,$grouptxt,$d2_type){
    document.getElementById("subplanid").value = $plan;
    document.getElementById("groupid").value = $grup;
    document.getElementById("groupd1id").value = $id1;
    document.getElementById("groupd2id").value = $d2;
    document.getElementById("groupd2Val").value = $valdata;
    document.getElementById("cd_type").value = $d2_type;
    document.getElementById("grouptxt").innerHTML = $grouptxt;
...
function hapusData($plan,$grup,$id1,$id2,$value){
    var r = confirm("Hapus Data : "+$value+"?");
    if (r == true) {
        $.post(frm+"?mode=hapus", {plan:$plan,grup:$grup,id1:$id1,id2:$id2}, function(resp,stat){
            alert(resp);
            editData($plan);
        });
    } else {
