...
var frm = "include/prdryingreporthsl.inc.php";

function lihatData(qpdh_id) {
    $('#myModal').modal('show');
    $.post(frm+"?mode=lihatdata", {qpdh_id:qpdh_id} , function(resp,stat){
...
$(document).ready(function () {
    ...
    $('#btnExport').click(function(){
        ...
        if (frmt == 'PDF') {
            ...
            window.open("include/mpdf-6.1.4/prdryingreporthsl.pdf.php?subplan="+$("#cmbSubplan").val()+"&tanggal="+$("#tglFrom").val()+"@"+$("#tglTo").val(),"",opsi);    
        }
         else if (frmt == 'XLSX') {
            opsi = "width=900,height=600,screenX=500,toolbars=1,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable='no'";
